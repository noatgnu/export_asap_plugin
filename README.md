...
**[⬇️ Click here to install in Cauldron](http://localhost:50060/install?repo=https%3A%2F%2Fgithub.com%2Fnoatgnu%2Fexport_asap_plugin)** _(requires Cauldron to be running)_
...
- `sdrf-pipelines==0.1.0 ; python_version >= "3.12"`
- `six==1.17.0 ; python_version >= "3.12"`
- `typing-extensions==4.15.0 ; python_version >= "3.12"`
- `typing-inspection==0.4.2 ; python_version >= "3.12"`
- `tzdata==2025.3 ; python_version >= "3.12" and (sys_platform == "win32" or sys_platform == "emscripten")`
